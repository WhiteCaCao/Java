...
class Order {
	...
	public Order() {
	} // 기본생성자 : 작성하지 않더라도 실행 가능(프로그램이 생성될 때 컴퓨터가 생성해주어서)
	// 생성자 : 인스턴스를 생성할 때 사용되는 메서드
	// 반드시 클래스 이름으로 만들어야하며 생성자를 작성하면 기본생성자는 없어지게됨
	// 여러개의 생성자 작성 방법 (생성자 오버러드)
	// 생성자의 매개변수의 갯수를 다르게 한다.
	// 생성자의 매개변수 자료형을 다르게 한다. (같은 자료형에 매개변수의 이름만 다른것을 만드는 것은 불가능)

	public Order(String orderNum, String orderId, String orderDate, String orderName, String orderItemNum,
			String orderAddress) {
...
public class OrderTest {
	...
	public static void main(String[] args) {
		...
		Order od2 = new Order("202311030002", "def123", "2023년11월03일", "이순신", "PD7890-54", "부산시 부산진구");
		od2.showOrderInfo();
